-- Create trading strategies tables
...
CREATE POLICY "Users can create their own strategies" ON trading_strategies FOR INSERT WITH CHECK (auth.uid() = author_id);
...
-- Policies for strategy_downloads
