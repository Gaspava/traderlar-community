        ...
        <div className="p-4 space-y-6 pt-24">
          ...
          <div className={`rounded-xl border p-4 ${
            ...
            <div className="flex items-center gap-2 mb-3">
              <Award className={`w-4 h-4 ${isDarkMode ? 'text-primary' : 'text-primary'}`} />
            ...
            <div className="space-y-3">
              ...
              <div className={`h-px ${isDarkMode ? 'bg-border' : 'bg-gray-200'} my-2`}></div>
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex gap-3">
                    <span className="text-orange-500 font-medium">
                      +{Math.floor(stats.totalTopics * 0.05)} konu
                    </span>
                    <span className="text-blue-500 font-medium">
                      +{Math.floor(stats.totalArticles * 0.03)} makale
                    </span>
                  </div>
                </div>
              </div>
