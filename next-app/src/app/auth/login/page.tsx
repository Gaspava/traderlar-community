    ...
    >
      ...
      <div className="bg-black/50 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-neutral-800">
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-400">Trading topluluğuna giriş yapın</p>
        </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-4 text-xs text-neutral-500">
          <span className="flex items-center gap-2">
            <span className="text-green-400">1000+</span> Üye
          </span>
          <span>•</span>
          <span className="flex items-center gap-2">
            <span className="text-green-400">500+</span> Strateji
          </span>
          <span>•</span>
          <span className="flex items-center gap-2">
            <span className="text-green-400">200+</span> Makale
          </span>
        </div>
      </div>
