...
export default function EditForumTopicPage() {
  ...
  const fetchTopic = async () => {
    try {
      ...
      alert('Konu yüklenirken hata oluştu');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Forum konusu başarıyla güncellendi!');
      router.push('/admin/forum-topics');
    } catch (error) {
      console.error('Error updating topic:', error);
      alert('Konu güncellenirken hata oluştu');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">Konu yükleniyor...</p>
        </motion.div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-foreground mb-4">Konu bulunamadı</h1>
          <Link 
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-2">Konu Düzenle</h1>
              <p className="text-muted-foreground">
                Forum konusunu düzenleyin
              </p>
            </div>
          </div>
        </motion.div>
